...
export default function RandomQuote() {
  ...
  return (
    <div className="bg-[#1E1E2E]/75 place-self-center w-11/12 max-w-md flex flex-col p-3 md:p-7 rounded-xl backdrop-blur-xs shadow-lg shadow-[#1E1E2E] border border-white/15 m-4">
      ...
      <div className="mb-6">
        ...
        {quote.character && (
          <div className="space-y-1 text-right">
            <p className="text-md md:text-lg text-white/80 font-cherry-bomb-one-regular">
              ~ {quote.character}
            </p>
            {quote.anime && (
